...
<div class="container" style="margin-top: 1rem;">
    ...
    <form action="" method="post">
        <div class="form-row">
            <div class="col">
                <input type="text" name="customerID" value="123" class="form-control" placeholder="Customer ID">
            </div>
            <div class="col">
                <input type="text" name="carMake" value="Ford" class="form-control" placeholder="Car Make">
            </div>
            <div class="col">
                <input type="text" name="carValue" value="1200" class="form-control" placeholder="Car Value">
            </div>
            <div class="col">
                <input type="date" name="carLastListed" value="2" class="form-control" placeholder="Car Last Listed">
            </div>
    ...
    <?php if(isset($car) && $car instanceof \App\Car): ?>
        ...
        <table class="table">
            ...
            <tr><th>Cuatomer ID</th> <td><?= $car->getCustomerId() ?></td></tr>
